...
class MyAuctionsController extends GetxController {
  ...
  void _loadDummyCars() async {
    ...
    final car1 = CarsListModel(
      ...
      imageUrl:
          'https://www.team-bhp.com/sites/default/files/styles/amp_high_res/public/inn1.jpeg',
      make: 'Toyota',
      model: 'Innova',
      variant: 'Crysta Z',
      priceDiscovery: 1800000,
      yearMonthOfManufacture: DateTime(2021, 7, 1),
      odometerReadingInKms: 45000,
      ownerSerialNumber: 2,
      fuelType: 'Diesel',
      commentsOnTransmission: 'Automatic',
      roadTaxValidity: 'LTT',
      taxValidTill: DateTime(2032, 5, 1),
    ...
    final car2 = CarsListModel(
      ...
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQmKK8mDcuxEh4U5aUR7XVk6ms9WeQHE469Q&s',
      make: 'Honda',
      model: 'City',
      variant: 'ZX CVT',
      priceDiscovery: 1000000,
      yearMonthOfManufacture: DateTime(2022, 2, 1),
      odometerReadingInKms: 18000,
      ownerSerialNumber: 1,
      fuelType: 'Petrol',
      commentsOnTransmission: 'Automatic',
      roadTaxValidity: '31/12/2032',
      taxValidTill: DateTime(2032, 12, 31),
      registrationNumber: 'MH03CD9876',
      ...
      isInspected: true,
      cubicCapacity: 1498,
      highestBid: 980000.0.obs,
      auctionStartTime: now.subtract(const Duration(hours: 30)),
      auctionEndTime: now.add(const Duration(hours: 5)),
      auctionDuration: 7,
      auctionStatus: 'live',
      upcomingTime: 0,
      upcomingUntil: now,
      liveAt: now.subtract(const Duration(hours: 30)),
      oneClickPrice: 1050000,
      otobuyOffer: 1020000,
      soldAt: 0,
      imageUrls: const [],
    );
