...
class GetWarrantyCarsListPage extends StatelessWidget {
  GetWarrantyCarsListPage({super.key});

  final GetWarrantyCarsListController getxController = Get.put(
    GetWarrantyCarsListController(),
  );
