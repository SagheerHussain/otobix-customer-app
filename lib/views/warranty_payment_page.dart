...
import 'package:otobix_customer_app/controllers/warranty_payment_controller.dart';
import 'package:otobix_customer_app/utils/app_colors.dart';
import 'package:otobix_customer_app/widgets/app_bar_widget.dart';
import 'package:otobix_customer_app/widgets/button_widget.dart';

class WarrantyPaymentPage extends StatelessWidget {
  WarrantyPaymentPage({super.key});

  final WarrantyPaymentController c = Get.put(WarrantyPaymentController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(title: 'Warranty Payment'),
      body: SafeArea(
  ...
  Widget _paymentTileUpi(BuildContext context) {
    return Obx(() {
      final expanded = c.expandedSection.value == PaymentSection.upi;
      ...
      return Container(
        ...
        child: Column(
          children: [
            InkWell(
              borderRadius: BorderRadius.circular(10),
              onTap: () => c.toggleSection(PaymentSection.upi),
              child: Row(
                children: [
                  Icon(
  ...
  Widget _paymentTileCards(BuildContext context) {
    return Obx(() {
      final expanded = c.expandedSection.value == PaymentSection.cards;
      ...
      return Container(
        ...
        child: Column(
          children: [
            InkWell(
              borderRadius: BorderRadius.circular(10),
              onTap: () => c.toggleSection(PaymentSection.cards),
              child: Row(
                children: [
                  Icon(
  ...
  Widget _paymentTileNetBanking(BuildContext context) {
    return Obx(() {
      final expanded = c.expandedSection.value == PaymentSection.netBanking;
      ...
      return Container(
        ...
        child: Column(
          children: [
            InkWell(
              borderRadius: BorderRadius.circular(10),
              onTap: () => c.toggleSection(PaymentSection.netBanking),
              child: Row(
                children: [
                  Icon(
